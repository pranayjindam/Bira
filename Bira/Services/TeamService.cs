...
namespace Bira.Services
{
    public class TeamService
    {
        ...
        public async Task<List<TeamModel>> GetTeamsAsync()
        {
            ...
            {
                new TeamModel { TeamId=1,Name = "Alpha Team", Members = new List<MemberModel>
                    {
                        new MemberModel { Name = "John", Role = "Developer" },
                        new MemberModel { Name = "Alice", Role = "Tester" }
                    }
                },
                new TeamModel { TeamId=2, Name = "Beta Team", Members = new List<MemberModel>
                    {
                        new MemberModel { Name = "Bob", Role = "Developer" }
                    }
                },
                new TeamModel { TeamId=3, Name = "Gamma Team", Members = new List<MemberModel>
                    {
